...
__
  ...
  * [__English](/en/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Русский](/ru/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__中文](/zh/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Español](/es/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Português](/pt/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__日本語](/ja/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Deutsch](/de/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__한국어](/ko/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Français](/fr/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Italiano](/it/docs/python_metatrader5/mt5symbolinfotick_py)
  * [__Türkçe](/tr/docs/python_metatrader5/mt5symbolinfotick_py)

[MQL5 Reference](/en/docs "MQL5 Reference")[Python
Integration](/en/docs/python_metatrader5 "Python Integration")symbol_info_tick
...
Return info in the form of a tuple. Return None in case of an error. The info
on the error can be obtained using
...
Tick(time=1585070338, bid=1.17264, ask=1.17279, last=0.0, volume=0,
time_msc=1585070338728, flags=2, volume_real=0.0)  
