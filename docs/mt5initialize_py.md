...
__
  ...
  * [__English](/en/docs/python_metatrader5/mt5initialize_py)
  * [__Русский](/ru/docs/python_metatrader5/mt5initialize_py)
  * [__中文](/zh/docs/python_metatrader5/mt5initialize_py)
  * [__Español](/es/docs/python_metatrader5/mt5initialize_py)
  * [__Português](/pt/docs/python_metatrader5/mt5initialize_py)
  * [__日本語](/ja/docs/python_metatrader5/mt5initialize_py)
  * [__Deutsch](/de/docs/python_metatrader5/mt5initialize_py)
  * [__한국어](/ko/docs/python_metatrader5/mt5initialize_py)
  * [__Français](/fr/docs/python_metatrader5/mt5initialize_py)
  * [__Italiano](/it/docs/python_metatrader5/mt5initialize_py)
  * [__Türkçe](/tr/docs/python_metatrader5/mt5initialize_py)

[MQL5 Reference](/en/docs "MQL5 Reference")[Python
Integration](/en/docs/python_metatrader5 "Python Integration")initialize
...
Establish a connection with the MetaTrader 5 terminal. There are three call
options.
...
initialize(  
   ...
   portable=False            //
[portable](https://www.metatrader5.com/en/terminal/help/start_advanced/start#portable)
mode  
   )  
---  
...
[in]  Path to the metatrader.exe or metatrader64.exe file. Optional unnamed
parameter. It is indicated first without a parameter name. If the path is not
specified, the module attempts to find the executable file on its own.

login=LOGIN

[in]  Trading account number. Optional named parameter. If not specified, the
last trading account is used.

password="PASSWORD"

[in]  Trading account password. Optional named parameter. If the password is
not set, the password for a specified trading account saved in the terminal
database is applied automatically.

server="SERVER"

[in]  Trade server name. Optional named parameter. If the server is not set,
the server for a specified trading account saved in the terminal database is
applied automatically.

timeout=TIMEOUT

[in]  Connection timeout in milliseconds. Optional named parameter. If not
specified, the value of 60 000 (60 seconds) is applied.

portable=False

[in]  Flag of the terminal launch in
[portable](https://www.metatrader5.com/en/terminal/help/start_advanced/start#portable)
mode. Optional named parameter. If not specified, the value of False is used.

Return Value

Returns True in case of successful connection to the MetaTrader 5 terminal,
otherwise - False.

Note

If required, the MetaTrader 5 terminal is launched to establish connection
when executing the initialize() call.
